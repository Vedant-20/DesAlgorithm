...
const Simulation = () => {
  ...
  const setDeCipheredText = () => {
    ...
    keys32.reverse();
    setDeCipheredText1(
      helper.DES(cipheredText1, keys1, 1, cipheredText1.length)
    );
    setDeCipheredText8(
      helper.DES(cipheredText8, keys8, 8, cipheredText8.length)
    );
    setDeCipheredText16(
      helper.DES(cipheredText16, keys16, 16, cipheredText16.length)
    );
    setDeCipheredText32(
      helper.DES(cipheredText32, keys32, 32, cipheredText32.length)
    );
    keys1.reverse();
    keys8.reverse();
    keys16.reverse();
      ...
      <div className="text-center mb-5 mt-5">
        ...
        <div className="block">
          <div className="mt-2 ">
            ...
            <b>
              {" "}
              Ciphered Text for Number of rounds equal to 1 = {
                cipheredText1
              }{" "}
            </b>{" "}
          </div>
          <div className="mt-2 ">
            ...
            <b>
              {" "}
              Ciphered Text for Number of rounds equal to 8 = {
                cipheredText8
              }{" "}
            </b>{" "}
          </div>
